...
import { FaBuilding, FaGlobe, FaUser, FaCalendarAlt, FaPlus } from "react-icons/fa";
          ...
          <div className="companies-grid">
            {companies.length === 0 ? (
              <div className="no-companies">
                ...
                <p>Be the first to register a company domain and start managing your organization's email system</p>
